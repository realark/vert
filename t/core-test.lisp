...
(deftest event-sub-test
  ...
  (labels ((has-subscriber-p (pub sub event-name)
    ...
    (let ((pub (make-instance 'camera))
      ...
      (is (num-subs pub 'recurse.vert::object-moved) 1000
          "correct number of move subs")
      (is (num-subs pub 'recurse.vert::camera-screen-resized) 20
